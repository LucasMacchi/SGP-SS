...
const PDFFumigacionesTanque = () => (
    <Document>
            ...
            <View style={{...stylePedido.view,textAlign:"center"}}>
                <Text style={stylePedido.titleActa}>AVISO DE LIMPIEZA DE TANQUE</Text>  
            </View>
            <View style={stylePedido.view}>
                <Text style={{...stylePedido.subtitleActa,fontWeight:400}}>El Dia .............. , ........../........../.......... a partir de las  ........ h. Se realizará</Text>
                <Text style={{...stylePedido.subtitleActa,fontWeight:400}}>LIMPIEZA Y DESINFECCION DE CISTERNA Y TANQUE DE AGUA POTABLE</Text>
                <Text style={{...stylePedido.subtitleActa,fontWeight:400}}>NOTA: Se recomienda almacenar algo de agua.</Text>
            </View>
...
export default PDFFumigacionesTanque