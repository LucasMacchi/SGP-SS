...
import { IDataPdf } from '../../Utils/Interfaces';
...
const DataDocument: React.FC<IDataPdf> = (data) => (
    <Document>
            ...
            <View style={stylePedido.view}>
                ...
                <View style={stylePedido.tableRow_header}>
                    <View style={stylePedido.tableColIns}>
                        <Text style={stylePedido.tableCell}>{data.solicitado}</Text>
                    </View>
                </View>
                </View>
                {data.datos.map((i) => (
                    <View style={stylePedido.tableRow}>
                        <View style={stylePedido.tableColIns}>
                            <Text style={stylePedido.tableCell}>{i}</Text>
                        </View>
                    </View>
                ))}
